...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="fixed top-0 left-0 right-0 z-50 bg-[#f9f9f9] border-b border-gray-200">
                {/* Main Navbar */}
                <div className="flex justify-between items-center px-4 py-2 h-14 max-w-[1440px] mx-auto">
                    ...
                    <div className="flex justify-center items-center">
                        <img src="/assets/img/logo/learnix.png" alt="Logo" className="h-8 w-32 ml-4"/>
                    </div>

                    {/* Right: Icons */}
                    <div className="flex justify-end items-center space-x-3 sm:hidden">
                        {/* Sun Icon */}
                        <FaSun className="text-[16px] cursor-pointer"/> {/* Cart Icon with Badge */}
                        ...
                        <div className="relative mt-2">
                            <button onClick={ToggleProfileDropdown}
                                ...
                                <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Profile" className="w-9 h-9 rounded-full object-cover cursor-pointer border border-gray-300"/>
                            </button>
                            ...
                            ProfileDropdown && (
                                <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                                    ...
                                    <div className="py-1">
                                        <button className="flex items-center w-full gap-2 px-4 py-2 text-left hover:bg-gray-100 text-sm text-red-600"
                                            onClick={
                                                () => handleLogout()
                                        }>
                                            <FaSignOutAlt/>
                ...
                <div className={
                    `fixed top-0 left-0 w-72 h-full bg-white shadow-lg z-40 transform transition-transform duration-300 sm:hidden ${
                        isMenuOpen ? "translate-x-0" : "-translate-x-full"
                    }`
                }>
                    {/* Header with logo and close icon */}
                    <div className="flex items-center justify-between px-4 py-3 border-b">
                        <img src="/assets/img/logo/learnix.png" alt="Logo" className="h-8 w-auto"/>
                        <button onClick={toggleMenu}
