...
import {deleteUserAsyncThunk, IsVerifyUserAsynThunk, PrivateAuthAsyncThunk} from "../../features/redux/Auth/authSlice";
        ...
        <>
            ...
            <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#f0f2f7] font-sans">
                ...
                <div className="w-full md:w-1/2 bg-white flex flex-col justify-between px-6 py-10 md:px-16">
                    <div className="max-w-md mx-auto flex-1 flex flex-col justify-center">
                        <div className="flex items-center justify-start mb-6">
                            <img src="/assets/img/logo/learnix.png" alt="Learnix Logo" className="w-30 h-8 object-contain"/>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-600 mb-6">
                                ...
                                <br></br>
                                <span className="text-[#2f46f0] font-medium">
                                    {email}</span>
                            </p>
                            ...
                            <div className="text-center mt-6">
                                <a href="https://mail.google.com/" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#2f46f0] hover:bg-[#1d2ec4] text-white px-5 py-2 rounded-md text-sm font-medium shadow">
                                    Open Gmail
                                </a>
                            </div>
                        </div>
                ...
                <div className="w-full md:w-1/2 bg-gradient-to-br from-[#3b90b1] to-[#356b86] text-white flex flex-col justify-center items-center px-6 md:px-16 py-10 md:py-0">
                    ...
                    <img src="/assets/img/auth/email.png" alt="Email Verification" className="w-full max-w-md h-auto object-contain"/>
                </div>
            </div>
        </>
    );
