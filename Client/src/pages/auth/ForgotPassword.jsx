      ...
      <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#f0f2f7]">
        ...
        <div className="w-full md:w-1/2 bg-white flex flex-col justify-between px-6 py-8 md:px-16 md:py-12">
          <div className="max-w-md mx-auto flex-1 flex flex-col justify-center">
            ...
            <form className="space-y-5" onSubmit={forgotFormik.handleSubmit}>
              <div>
                <label
                  htmlFor="email"
                ...
                <div className="relative">
                  <input
                    ...
                    onBlue={forgotFormik.handleBlur}
              ...
              <button
                type="submit"
                className="w-full bg-[#2f46f0] text-white py-2 text-sm font-semibold hover:bg-[#2439c0] transition rounded-md"
              >
                {isLoading ? (
