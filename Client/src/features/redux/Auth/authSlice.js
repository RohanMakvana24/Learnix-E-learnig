...
import {decryptBoolean, encryptBoolean} from "../../../component/features/Hashing";
...
const isAuthenticated = decryptBoolean(localStorage.getItem("isAuthenticated") || "false") || false;
...
const authSlices = createSlice({
    ...
    extraReducers: (builder) => { // * Signup Builder *
        ...
        builder.addCase(PrivateAuthAsyncThunk.pending, (state) => {
            ...
            localStorage.setItem("isAuthenticated", encryptBoolean(true));
